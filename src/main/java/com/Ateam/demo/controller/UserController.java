...
public class UserController {
    ...
    /**
     * localhost:8080 시 index(메인화면) 으로 redirect //예정
     * @return
     */
    @GetMapping
    public String root() {
    ...
    public String CreateReservationGuest(Model model, Authentication authentication) {
    ...
    public String CreateReservationAdmin(Model model,Authentication authentication) {
