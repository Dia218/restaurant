...
<form id="modifyForm" action="/modifyReservationGuest" method="post">
...
<form id="infoForm" action="/reservationInfoGuest" method="get">
...
<script>
    ...
    $("#list_btn").on("click", function(e){
        ...
        form.attr("action", "/reservationListGuest");
        form.submit();
    });
    ...
    $("#delete_btn").on("click", function(e){
        form.attr("action", "/deleteReservationGuest");
