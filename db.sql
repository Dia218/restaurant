...
CREATE TABLE TB_REVIEW (
    REVIEW_NO int(11) NOT NULL AUTO_INCREMENT COMMENT '리뷰번호',
    USER_ID VARCHAR(255) NOT NULL COMMENT '작성자아이디',
    REVIEW_TEXT varchar(255) NOT NULL COMMENT '후기텍스트',
    REVIEW_POINT int(1) NOT NULL COMMENT '평점',
    APPEND_DATE datetime DEFAULT NULL COMMENT '추가날짜',
